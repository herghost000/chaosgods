...
export const makeCTimePickerClockProps = propsFactory({
...
export const CTimePickerClock = genericComponent()({
  name: 'CTimePickerClock',

  props: makeCTimePickerClockProps(),
  ...
  setup(props, { emit }) {
    ...
    function angleToValue(angle: number, insideClick: boolean): number {
      ...
      if (angle < (360 - degreesPerUnit.value / 2))
        return value
...
export type CTimePickerClock = InstanceType<typeof CTimePickerClock>
