import './CCalendarInterval.sass'
import { computed } from 'vue'
import { CCalendarIntervalEvent } from './CCalendarIntervalEvent'
import { useDate } from '@/composables/date'
import { convertToUnit, genericComponent, propsFactory, useRender } from '@/util'

export const makeCCalendarIntervalProps = propsFactory({
  day: {
    type: Object,
    default: () => ({}),
  },
...
export const CCalendarInterval = genericComponent()({
  name: 'CCalendarInterval',
...
export type CCalendarInterval = InstanceType<typeof CCalendarInterval>
