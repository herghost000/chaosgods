...
export const IconSymbol: InjectionKey<Required<IconOptions>> = Symbol.for('chaos:icons')
...
export function createIcons(options?: IconOptions) {
  ...
  return mergeDeep({
    ...
    aliases: {
      ...
      'chaos-outline': 'svg:M7.26 12.47 12.53 3H2L7.26 12.47ZM14.45 3 8.22 14.2 12 21 22 3H14.45ZM18.6 5 12 16.88 10.51 14.2 15.62 5ZM7.26 8.35 5.4 5H9.13L7.26 8.35Z',
      'chaos-play': [
...
export function useIcon(props: Ref<IconValue | undefined>) {
  const icons = inject(IconSymbol)

  if (!icons)
    throw new Error('Missing Chaos Icons provide!')

  const iconData = computed<IconInstance>(() => {
    const iconAlias = unref(props)

    if (!iconAlias)
      return { component: VComponentIcon }
