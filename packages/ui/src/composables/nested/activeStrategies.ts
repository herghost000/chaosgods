...
export function independentActiveStrategy(mandatory?: boolean): ActiveStrategy {
...
export function independentSingleActiveStrategy(mandatory?: boolean): ActiveStrategy {
...
export function leafActiveStrategy(mandatory?: boolean): ActiveStrategy {
  const parentStrategy = independentActiveStrategy(mandatory)
...
export function leafSingleActiveStrategy(mandatory?: boolean): ActiveStrategy {
