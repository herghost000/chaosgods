...
import { CResponsive, makeCResponsiveProps } from '@/components/CResponsive/CResponsive'
...
export const makeCImgProps = propsFactory({
  alt: String,
  cover: Boolean,
  color: String,
  draggable: {
  ...
  ...makeCResponsiveProps(),
  ...makeComponentProps(),
  ...makeRoundedProps(),
  ...makeTransitionProps(),
}, 'CImg')

export const CImg = genericComponent<CImgSlots>()({
  name: 'CImg',
  ...
  emits: {
    loadstart: (_value: string | undefined) => true,
    load: (_value: string | undefined) => true,
    error: (_value: string | undefined) => true,
  },

  setup(props, { emit, slots }) {
    const { backgroundColorClasses, backgroundColorStyles } = useBackgroundColor(toRef(props, 'color'))
    const { roundedClasses } = useRounded(props)
    const vm = getCurrentInstance('CImg')
    ...
    useRender(() => {
      const responsiveProps = CResponsive.filterProps(props)
      return (
        <CResponsive
          class={[
            'v-img',
...
export type CImg = InstanceType<typeof CImg>
