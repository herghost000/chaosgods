import './CSliderThumb.sass'
import { computed, inject } from 'vue'
import type { PropType } from 'vue'
import { CScaleTransition } from '../transitions'
...
export type CSliderThumbSlots = {
  'thumb-label': { modelValue: number }
}

export const makeCSliderThumbProps = propsFactory({
  focused: Boolean,
  max: {
    type: Number,
    required: true,
...
export const CSliderThumb = genericComponent<CSliderThumbSlots>()({
  name: 'CSliderThumb',

  directives: { Ripple },

  props: makeCSliderThumbProps(),
    ...
    useRender(() => {
      ...
      return (
        ...
        >
          ...
          />
          <CScaleTransition origin="bottom center">
            <div
...
export type CSliderThumb = InstanceType<typeof CSliderThumb>
