...
import { IN_BROWSER, convertToUnit, getScrollParents, hasScrollbar, propsFactory } from '@/util'
...
function blockScrollStrategy(data: ScrollStrategyData, props: StrategyProps) {
  ...
  onScopeDispose(() => {
    scrollElements.forEach((el, _i) => {
      const x = Number.parseFloat(el.style.getPropertyValue('--v-body-scroll-x'))
      const y = Number.parseFloat(el.style.getPropertyValue('--v-body-scroll-y'))
