...
export const makeCBottomNavigationProps = propsFactory({
  baseColor: String,
  bgColor: String,
  color: String,
  grow: Boolean,
...
export const CBottomNavigation = genericComponent<new<T>(
  props: {
    'modelValue'?: T
  ...
  name: 'CBottomNavigation',

  props: makeCBottomNavigationProps(),

  emits: {
    'update:active': (_value: any) => true,
  ...
  setup(props, { slots }) {
    ...
    useGroup(props, CBtnToggleSymbol)
