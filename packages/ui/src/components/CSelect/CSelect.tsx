...
export const makeSelectProps = propsFactory({
  ...
  listProps: {
    type: Object as PropType<CList['$props']>,
  },
  menu: Boolean,
  menuIcon: {
    type: IconValue,
  ...
  menuProps: {
    type: Object as PropType<CMenu['$props']>,
  },
  multiple: Boolean,
  noDataText: {
    type: String,
...
export const makeCSelectProps = propsFactory({
  ...makeSelectProps(),
  ...omit(makeCTextFieldProps({
    modelValue: null,
    role: 'combobox',
  }), ['validationValue', 'dirty', 'appendInnerIcon']),
  ...makeTransitionProps({ transition: { component: CDialogTransition as Component } }),
}, 'CSelect')

type ItemType<T> = T extends readonly (infer U)[] ? U : never

export const CSelect = genericComponent<new<
...
export type CSelect = InstanceType<typeof CSelect>
