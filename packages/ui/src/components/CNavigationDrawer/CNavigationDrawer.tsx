import './CNavigationDrawer.sass'
import { Transition, computed, nextTick, ref, shallowRef, toRef, watch } from 'vue'
...
export type CNavigationDrawerImageSlot = {
  image: string | undefined
}

export type CNavigationDrawerSlots = {
  default: never
  prepend: never
  append: never
  image: CNavigationDrawerImageSlot
}

const locations = ['start', 'end', 'left', 'right', 'top', 'bottom'] as const

export const makeCNavigationDrawerProps = propsFactory({
  color: String,
...
export const CNavigationDrawer = genericComponent<CNavigationDrawerSlots>()({
  name: 'CNavigationDrawer',

  props: makeCNavigationDrawerProps(),

  emits: {
    'update:modelValue': (_val: boolean) => true,
    'update:rail': (_val: boolean) => true,
  },
...
export type CNavigationDrawer = InstanceType<typeof CNavigationDrawer>
