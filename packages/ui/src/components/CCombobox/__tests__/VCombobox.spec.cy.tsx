...
const stories = Object.fromEntries(Object.entries({
  'Default input': <CCombobox />,
  'Disabled': <CCombobox items={items} disabled />,
  'Affixes': <CCombobox items={items} prefix="prefix" suffix="suffix" />,
  'Prepend/append': <CCombobox items={items} prependIcon="$vuetify" appendIcon="$vuetify" />,
  'Prepend/append inner': <CCombobox items={items} prependInnerIcon="$vuetify" appendInnerIcon="$vuetify" />,
  'Placeholder': <CCombobox items={items} placeholder="placeholder" persistentPlaceholder />,
}).map(([k, v]) => {
  return [k, (<div class="d-flex flex-column flex-grow-1">
...
describe('cCombobox', () => {
  describe('closableChips', () => {
    it('should close only first chip', () => {
      ...
      cy.mount(() => (
        <CCombobox items={items} modelValue={selectedItems} multiple closableChips chips />
      ))
  ...
  describe('search', () => {
    ...
    it('should filter items when using multiple', () => {
      ...
      cy.mount(() => (
        <CCombobox items={items} multiple />
      ))
        .get('input')
        .type('Item')
      cy.get('.v-list-item')
  ...
  describe('prefilled data', () => {
    it('should work with array of strings when using multiple', () => {
      ...
      cy.mount(() => (
        <CCombobox v-model={selectedItems.value} items={items.value} multiple chips closableChips />
      ))
  ...
  describe('hide-selected', () => {
    it('should hide selected item(s)', () => {
      ...
      cy.mount(() => (
        <CCombobox items={items} modelValue={selectedItems} multiple hideSelected />
      ))
  ...
  it('should conditionally show placeholder', () => {
    cy.mount(props => (
      <CCombobox placeholder="Placeholder" {...props} />
    ))
  ...
  it('should not show menu when focused and existing non-empty items are changed', () => {
    cy
      .mount((props: any) => (<CCombobox items={props.items} />))
      .setProps({ items: ['Foo', 'Bar'] })
      .get('.v-combobox')
      .click()
      .get('.v-overlay')
