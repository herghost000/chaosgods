...
import { makeCTextFieldProps } from '@/components/CTextField/CTextField'
...
export const makeCComboboxProps = propsFactory({
  autoSelectFirst: {
...
export const CCombobox = genericComponent<new<
...
>(
  ...
  setup(props, { emit, slots }) {
    ...
    watch(_search, (value) => {
      if (cleared) {
        // wait for clear to finish, CTextField sets _search to null
    ...
    function onFocusin(_: FocusEvent) {
...
export type CCombobox = InstanceType<typeof CCombobox>
