import './CIcon.sass'
import { Text, computed, ref, toRef } from 'vue'
...
export const makeCIconProps = propsFactory({
  color: String,
  disabled: Boolean,
  start: Boolean,
  end: Boolean,
...
export const CIcon = genericComponent()({
  name: 'CIcon',

  props: makeCIconProps(),
...
export type CIcon = InstanceType<typeof CIcon>
