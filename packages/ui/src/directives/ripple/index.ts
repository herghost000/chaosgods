...
type ChaosRippleEvent = (MouseEvent | TouchEvent | KeyboardEvent) & { [stopSymbol]?: boolean }
...
function isTouchEvent(e: ChaosRippleEvent): e is TouchEvent {
  return e.constructor.name === 'TouchEvent'
}

function isKeyboardEvent(e: ChaosRippleEvent): e is KeyboardEvent {
  return e.constructor.name === 'KeyboardEvent'
}

function calculate(e: ChaosRippleEvent, el: HTMLElement, value: RippleOptions = {}) {
  let localX = 0
  let localY = 0
...
function rippleShow(e: ChaosRippleEvent) {
...
function rippleStop(e: ChaosRippleEvent) {
  e[stopSymbol] = true
}
